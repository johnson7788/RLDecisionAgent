...
def main():
    ...
    parser.add_argument("--train", default="scenarios/train.jsonl", help="输出训练集文件（默认：train.jsonl）")
    parser.add_argument("--val", default="scenarios/val.jsonl", help="输出验证集文件（默认：val.jsonl）")
